...
<template>
  ...
  <!-- 使用css -->
  <div class="space-y-4">
  <span class="block max-w-xs text-3xl bg-pink-400">1</span>
  <span class="block max-w-7xl text-8xl bg-blue-500">2</span>
  <span class="block max-w-md text-xl bg-green-400">3</span>
  </div>
<h1 class="text-8xl">a</h1>
